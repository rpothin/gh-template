...
func auditSettings(settings config.RepoSettings, live *ghapi.RepoInfo, driftCount *int) {
	...
	compareBoolSetting("has_downloads", settings.HasDownloads, live.HasDownloads, driftCount)
	...
	compareBoolSetting("is_template", settings.IsTemplate, live.IsTemplate, driftCount)
